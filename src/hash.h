 ...
 *
 * Devuelve un puntero al hash creado o NULO en caso de no poder
 * crearlo.
 */
 ...
 *
 * Devuelve EXITO si pudo guardarlo o ERROR si no pudo.
 */
 ...
 * Devuelve EXITO si pudo eliminar el elemento o ERROR si no pudo.
 */
int hash_quitar(hash_t* hash, const char* clave);

/*
 * Devuelve un elemento del hash con la clave dada o NULO si dicho
...
/*
 * Devuelve la cantidad de elementos almacenados en el hash o NULO en
 * caso de error.
 */
 ...
 * veces que fue invocada la función) o NULO en caso de error.
 *
 */
